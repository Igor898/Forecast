...
const weatherImage = computed(() => {
  return `background-image: url('/Forecast/src/assets/img/weather-main/${props.weatherInfo?.weather[0].description}.png');`;
});
...
<template>
  <div class="summary">
    ...
    <div class="weather">
      ...
      <div class="weather-desc text-block">{{doUperCase(weatherInfo?.weather[0].description)}}</div>
    </div>
